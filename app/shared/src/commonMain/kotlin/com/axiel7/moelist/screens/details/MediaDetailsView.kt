...
import com.axiel7.moelist.ui.generated.resources.ic_round_edit_24
import com.axiel7.moelist.ui.generated.resources.ic_round_group_24
import com.axiel7.moelist.ui.generated.resources.ic_round_keyboard_arrow_down_24
import com.axiel7.moelist.ui.generated.resources.ic_round_keyboard_arrow_up_24
import com.axiel7.moelist.ui.generated.resources.ic_round_local_movies_24
import com.axiel7.moelist.ui.generated.resources.ic_round_menu_book_24
import com.axiel7.moelist.ui.generated.resources.ic_round_rss_feed_24
import com.axiel7.moelist.ui.generated.resources.ic_round_thumbs_up_down_16
import com.axiel7.moelist.ui.generated.resources.ic_round_thumbs_up_down_24
import com.axiel7.moelist.ui.generated.resources.ic_round_timer_24
import com.axiel7.moelist.ui.generated.resources.ic_round_trending_up_24
import com.axiel7.moelist.ui.generated.resources.jp_title
import com.axiel7.moelist.ui.generated.resources.lorem_ipsun
import com.axiel7.moelist.ui.generated.resources.members
import com.axiel7.moelist.ui.generated.resources.more_info
import com.axiel7.moelist.ui.generated.resources.opening
...
import com.axiel7.moelist.ui.generated.resources.related_anime
...
import com.axiel7.moelist.ui.generated.resources.source
import com.axiel7.moelist.ui.generated.resources.start_date
import com.axiel7.moelist.ui.generated.resources.stats
import com.axiel7.moelist.ui.generated.resources.status_distribution
...
private fun MediaDetailsContent(
    ...
    val iconExpand by remember {
        derivedStateOf {
            if (isSynopsisExpanded) UiRes.drawable.ic_round_keyboard_arrow_up_24
            else UiRes.drawable.ic_round_keyboard_arrow_down_24
        }
    }
    val isCurrentLanguageEn = remember { Locale.current.toLanguageTag().startsWith("en") }
    ...
    Scaffold(
        ...
        Column(
            ...
            Row {
                ...
                Column {
                    ...
                    TextIconHorizontal(
                        ...
                        else UiRes.drawable.ic_round_book_24,
                        modifier = Modifier
                            .padding(bottom = 8.dp)
                            .defaultPlaceholder(visible = uiState.isLoading)
                    )
                    TextIconHorizontal(
                        ...
                        icon = if (uiState.isAnime) UiRes.drawable.ic_round_rss_feed_24
                        else UiRes.drawable.round_drive_file_rename_outline_24,
                        modifier = Modifier
                            .padding(bottom = 8.dp)
                            .defaultPlaceholder(visible = uiState.isLoading)
                    )
                    TextIconHorizontal(
                        ...
                        icon = if (uiState.isAnime) UiRes.drawable.ic_round_timer_24
                        else UiRes.drawable.ic_round_menu_book_24,
                        modifier = Modifier
                            .padding(bottom = 8.dp)
                            .defaultPlaceholder(visible = uiState.isLoading)
                    )
                ...
                SelectionContainer {
                    Text(
                        text = synopsisAndBackground
                            ?: AnnotatedString(stringResource(UiRes.string.lorem_ipsun)),
                        modifier = Modifier
            ...
            //Stats
            InfoTitle(text = stringResource(UiRes.string.stats))
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(8.dp)
                ...
                TextIconVertical(
                    ...
                    icon = UiRes.drawable.ic_round_bar_chart_24,
                    tooltip = stringResource(UiRes.string.top_ranked)
                )
                VerticalDivider(modifier = Modifier.height(32.dp))

                TextIconVertical(
                    text = uiState.mediaDetails?.numScoringUsers?.format() ?: UNKNOWN_CHAR,
                    icon = UiRes.drawable.ic_round_thumbs_up_down_24,
                    tooltip = stringResource(UiRes.string.users_scores)
                )
                VerticalDivider(modifier = Modifier.height(32.dp))
                ...
                TextIconVertical(
                    ...
                    tooltip = stringResource(UiRes.string.members)
                )
                VerticalDivider(modifier = Modifier.height(32.dp))

                TextIconVertical(
                    text = "# ${uiState.mediaDetails?.popularity}",
                    icon = UiRes.drawable.ic_round_trending_up_24,
                    tooltip = stringResource(UiRes.string.popularity)
                )
            }//:Row

            //Info
            InfoTitle(text = stringResource(UiRes.string.more_info))
            if (uiState.mediaDetails is AnimeDetails) {
                MediaInfoView(
                    title = stringResource(UiRes.string.duration),
                ...
                SelectionContainer {
                    MediaInfoView(
                        title = stringResource(UiRes.string.authors),
                ...
                SelectionContainer {
                    MediaInfoView(
                        title = stringResource(UiRes.string.serialization),
            ...
            MediaInfoView(
                title = stringResource(UiRes.string.start_date),
                info = uiState.mediaDetails?.startDate?.parseDateAndLocalize(),
                modifier = Modifier.defaultPlaceholder(visible = uiState.isLoading)
            )
            MediaInfoView(
                title = stringResource(UiRes.string.end_date),
                info = uiState.mediaDetails?.endDate?.parseDateAndLocalize(),
                modifier = Modifier.defaultPlaceholder(visible = uiState.isLoading)
            )
            if (uiState.mediaDetails is AnimeDetails) {
                MediaInfoView(
                    title = stringResource(UiRes.string.season),
                    info = uiState.mediaDetails.startSeason?.seasonYearText(),
                    modifier = Modifier.defaultPlaceholder(visible = uiState.isLoading)
                )
                MediaInfoView(
                    title = stringResource(UiRes.string.broadcast),
                ...
                MediaInfoView(
                    title = stringResource(UiRes.string.source),
            ...
            if (uiState.mediaDetails is AnimeDetails) {
                SelectionContainer {
                    MediaInfoView(
                        title = stringResource(UiRes.string.studios),
            ...
            uiState.mediaDetails?.synonymsJoined()?.let { synonyms ->
                SelectionContainer {
                    MediaInfoView(
                        title = stringResource(UiRes.string.synonyms),
                        info = synonyms,
                        modifier = Modifier.defaultPlaceholder(visible = uiState.isLoading)
                    )
                }
            ...
            SelectionContainer {
                MediaInfoView(
                    title = stringResource(UiRes.string.jp_title),
            ...
            SelectionContainer {
                MediaInfoView(
                    title = stringResource(UiRes.string.romaji),
            ...
            SelectionContainer {
                MediaInfoView(
                    title = stringResource(UiRes.string.english),
            ...
            if (uiState.isAnime) {
                ...
                if (uiState.characters.isNotEmpty() || uiState.isLoadingCharacters) {
                    ...
                    TextButton(
                        ...
                        Text(text = stringResource(UiRes.string.view_characters))
                    }
                }
            }
            ...
            (uiState.mediaDetails as? AnimeDetails)?.statistics?.status?.toStats()?.let { stats ->
                InfoTitle(text = stringResource(UiRes.string.status_distribution))
                HorizontalStatsBar(
                    stats = stats
                )
            }
