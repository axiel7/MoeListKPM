package com.axiel7.moelist.screens.search
...
private fun SearchViewContent(
                ...
                Text(
                    text = when (item) {
                        is AnimeList -> item.node.startSeason?.seasonYearText()
                            ?: stringResource(UiRes.string.unknown)
    ...
    fun NoResultsText() {
        Column(
            ...
            Text(
                text = stringResource(UiRes.string.no_results),
    ...
    fun SearchHistoryItem(
        ...
        Row(
            ...
            Icon(
                painter = painterResource(UiRes.drawable.ic_history_24),
